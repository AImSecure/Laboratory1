...
\section{TASK 2 --- SHALLOW FEED-FORWARD NEURAL NETWORK (FFNN)} \label{sec:shallow-nn}
    ...
    \subsection{Training Dynamics}
        ...
        All models converged to similar validation loss levels (\textasciitilde 0.29), with the 64-neuron model early stopping at 100 epochs.
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}{0.48\textwidth}
                ...
                \begin{tabular}{lcccc}
                    ...
                    \midrule
                    \textbf{0} \textit{Benign}      & 0.8872 & 0.9524 & 0.9187 \\
                    \textbf{1} \textit{Brute Force} & 0.0000 & 0.0000 & 0.0000 \\
                    \textbf{2} \textit{DoS Hulk}    & 0.9854 & 0.8758 & 0.9274 \\
                    \textbf{3} \textit{Port Scan}   & 0.8270 & 0.8918 & 0.8581 \\
                    \bottomrule
                \end{tabular}
                \vspace{0.3cm}
                \captionof{table}{Full validation report for the 64-neuron model.}
    ...
    \subsection{Validation Performance Analysis}
        ...
        \begin{table}[h]
            ...
            \begin{tabular}{lcccc}
                \toprule
                \textbf{Model} & \textbf{Accuracy} & \textbf{F1 (macro avg)} & \textbf{F1 (weighted avg)} \\
                \midrule
        ...
        The \textbf{64}-neuron model matched this accuracy while slightly improving macro F1 (0.6760 vs. 0.6709 for 128 neurons) by better balancing class predictions.
    ...
    \subsection{Activation Function Study and Generalization}
        ...
        In particular, the Brute Force class (1) F1 rose from 0.28 (linear model; Table~\ref{tab:linear-metrics}) to 0.77 with ReLU (Table~\ref{tab:relu_64-metrics}), showing that ReLU helped capture more complex patterns for this rare attack type.  
        ...
        \begin{figure}[H]
            ...
            \begin{minipage}{0.48\textwidth}
                ...
                \begin{tabular}{lcccc}
                    ...
                    \textbf{Class} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-Score} \\
                    \midrule
                    \textbf{0} \textit{Benign}      & 0.9593 & 0.9675& 0.9634 \\
                    \textbf{1} \textit{Brute Force} & 0.7768 & 0.9371 & 0.8494 \\
                    \textbf{2} \textit{DoS Hulk}    & 0.9986 & 0.9043 & 0.9491 \\
                    \textbf{3} \textit{Port Scan}   & 0.9380 & 0.9196 & 0.9287 \\
                    \midrule
                \end{tabular}
                \begin{tabular}{c c c}
