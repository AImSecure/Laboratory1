...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\linewidth]{images/task5/deep_L3_widths_32_16_8_loss_curve.png}
    \caption{Training and validation loss of the best deep model (3 layers, widths [32, 16, 8]).}
    \label{fig:deep_L3}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\linewidth]{images/task5/64_loss_curve.png}
