        ...
        \begin{figure}[H]
            ...
            \begin{minipage}{0.48\textwidth}
                ...
                \begin{tabular}{lcccc}
                    ...
                    \midrule
                    \textbf{0} \textit{Benign}      & 0.9023 & 0.9696 & 0.9348 \\
                    \textbf{1} \textit{Brute Force} & 0.1705 & 0.0526 & 0.0804 \\
                    \textbf{2} \textit{DoS Hulk}    & 0.9944 & 0.9160 & 0.9536 \\
                    \textbf{3} \textit{Port Scan}   & 0.9384 & 0.9103 & 0.9241 \\
                    \midrule
                \end{tabular}
                \begin{tabular}{c c c}
                    \textbf{Accuracy} &  \textbf{Macro F1} & \textbf{Weighted F1} \\
                    0.9544 & 0.9279 & 0.9548 \\
                \end{tabular}
                \vspace{0.3cm}
