...
\section{TASK 4 --- THE IMPACT OF THE LOSS FUNCTION (CLASS WEIGHTED)} \label{sec:impact-loss-function}
    ...
    \subsection{Removing the Destination Port Feature}
        ...
        However, the ability to recognize the rarest class, \textit{PortScan}, declined significantly (F1-score dropped from 0.92 to 0.30), suggesting that the model had previously exploited this feature as a strong shortcut for \textit{PortScan} detection.
